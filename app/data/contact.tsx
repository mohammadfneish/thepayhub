    ...
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 14 14">
        <path
          ...
          d="M9.5 13.5V11h2a1 1 0 0 0 1-1V6a5.5 5.5 0 1 0-8 4.9v2.6"
        />
      </svg>
    ),
  },
...
export const ourOfficesData: Array<OurOffices> = [
  {
    ...
    img: '/images/contact/miami.webp?v=1',
    address: [],
    phone: '',
    email: '',
  },
  {
    ...
    img: '/images/contact/detroit.webp?v=1',
    address: [],
    phone: '',
    email: '',
  },
  {
    location: 'Dubai, UAE ',
    img: '/images/contact/dubai.webp?v=1',
    address: [],
    phone: '',
    email: '',
  },
  {
    ...
    img: '/images/contact/sao-paulo.webp?v=1',
    address: [],
    phone: '',
    email: '',
  },
  {
    location: 'Cuidad del este, Paraguay ',
    img: '/images/contact/cuidad-del-este.webp?v=1',
    address: [],
    phone: '',
    email: '',
  },
  {
    ...
    img: '/images/contact/panama.webp?v=1',
    address: [],
    phone: '',
    email: '',
  },
  {
    ...
    img: '/images/contact/colombia.webp?v=1',
    address: [],
    phone: '',
    email: '',
  },
