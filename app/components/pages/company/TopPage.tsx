...
export default function TopPage() {
  return (
    <div className="py-20 h-auto bg-top bg-no-repeat" style={{backgroundImage: 'url(/images/cubes.webp?v=3)'}}>
      ...
      <div
        ...
        style={{backgroundImage: 'url(/images/company/thepayhub.webp?v=3)'}}>
        <p
